...
(defn- train-crf
  ...
  (let [
        training-file (File/createTempFile "ner-data" ".tsv")
        props         (-> opts
                          (merge file-opts)
                          (assoc
...
(defn train
  ...
  (train-crf (conj feature-dataset target-dataset)
...
(defn predict
  ...
  The data need to be given as texts in the feature column of the dataset.
